...
using System.Diagnostics.CodeAnalysis;
    ...
    public class Assert
    {
        ...
        public static void Contains<T>(T expected, IEnumerable<T> collection, IEqualityComparer<T> comparer)
        {
			...
			throw new Exception (expected.ToString ());
        }
        ...
        public static void Contains(string expectedSubstring, string actualString, StringComparison comparisonType)
        {
			...
			throw new Exception(expectedSubstring+" "+actualString);
        }
        ...
        {
            if (actualString != null && actualString.IndexOf(expectedSubstring, comparisonType) >= 0)
			throw new Exception(expectedSubstring);
        }
...
#pragma warning restore 168
        ...
        public static void Equal<T>(T expected, T actual, IEqualityComparer<T> comparer)
        {
			...
			throw new Exception(expected.ToString()+" "+actual.ToString());
        }
        ...
        public static void InRange<T>(T actual, T low, T high, IComparer<T> comparer)
        {
			...
			throw new Exception(actual.ToString()+" "+low.ToString()+" "+high.ToString());
        }
        ...
        public static void IsAssignableFrom(Type expectedType, object @object)
        {
			...
			throw new Exception(expectedType.ToString()+" "+@object.ToString());
        }
...
#pragma warning restore 168
        ...
        public static void Single(IEnumerable collection, object expected)
        {
            ...
            if (count != 1)
			throw new Exception(count.ToString()+" "+expected.ToString());
        }
        ...
        public static Exception Throws(Type exceptionType, ThrowsDelegate testCode)
        {
			...
			throw new Exception(exceptionType.ToString()+" "+exception.ToString());
